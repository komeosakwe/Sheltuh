...
export const BOOKING_FEE_RATE = 0.04;
 ...
 * a A$0.52 fee), which Stripe rejects; A$0.50 is also Stripe's minimum AUD
...
/**
 * Booking fee for a single paid ticket: 4% of face value + A$0.50.
