...
export default function ApplyPageContent() {
  ...
  if (!current) {
    return (
      <div className="flex flex-col gap-6">
        ...
        <ApplicationForm mode="apply" idToken={auth.idToken as string} onSuccess={setJustSubmitted} />
      </div>
    );
  }
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <ApplicationForm mode="resubmit" idToken={auth.idToken as string} initial={current} onSuccess={setJustSubmitted} />
    </div>
  );
}
